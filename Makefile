...
# Project:  game\cpp_shixun.pro
# Template: app
# Command: C:\Qt\6.2.4\mingw_64\bin\qmake.exe -o Makefile game\cpp_shixun.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: game/cpp_shixun.pro ../../6.2.4/mingw_64/mkspecs/features/spec_pre.prf \
		...
		game/image.qrc
	$(QMAKE) -o Makefile game\cpp_shixun.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
