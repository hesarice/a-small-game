#############################################################################
# Makefile for building: cpp_shixun
# Generated by qmake (3.1) (Qt 6.2.4)
# Project:  cpp_shixun.pro
# Template: app
# Command: C:\Qt\6.2.4\mingw_64\bin\qmake.exe -o Makefile cpp_shixun.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: cpp_shixun.pro ../../../6.2.4/mingw_64/mkspecs/win32-g++/qmake.conf ../../../6.2.4/mingw_64/mkspecs/features/spec_pre.prf \
		...
		../../../6.2.4/mingw_64/lib/Qt6Multimedia.prl \
		../../../6.2.4/mingw_64/lib/Qt6Gui.prl \
		../../../6.2.4/mingw_64/lib/Qt6Network.prl \
		../../../6.2.4/mingw_64/lib/Qt6Core.prl \
		../../../6.2.4/mingw_64/lib/Qt6EntryPoint.prl \
		../../../6.2.4/mingw_64/mkspecs/features/build_pass.prf \
		image.qrc
	$(QMAKE) -o Makefile cpp_shixun.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
